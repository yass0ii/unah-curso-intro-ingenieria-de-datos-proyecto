...
CREATE TABLE Countries (
    ...
    dec_population DECIMAL(20,2) NOT NULL COMMENT "Cantidad de habitantes",
    dec_population_growth_percent DECIMAL(30,5) NOT NULL COMMENT "Porcentaje de crecimiento poblacional",
    dec_area_km_sq DECIMAL(20,2) NOT NULL COMMENT "Área en km cuadrados",
    ...
    dec_population_density DECIMAL(20,2) NOT NULL COMMENT "Densidad poblacional"
) COMMENT "Datos generales del país";

CREATE TABLE Economy (
    id SERIAL PRIMARY KEY,
    id_countries_fk BIGINT UNSIGNED NOT NULL COMMENT "Referencia hacia countries",
    dec_GDP_general_billion_of_dollars DECIMAL(30,2) NOT NULL COMMENT "PIB PAÍS",
    dec_GDP_contribution_agriculture_percent DECIMAL(20,2) NOT NULL COMMENT "Aporte de agricultura al PIB",
    dec_GDP_contribution_industry_percent DECIMAL(20,2) NOT NULL COMMENT "Aporte de industria al PIB",
    dec_GDP_contribution_service_percent DECIMAL(20,2) NOT NULL COMMENT "Aporte de servicios al PIB",
...
CREATE TABLE Education (
    id SERIAL PRIMARY KEY,
    id_countries_fk BIGINT UNSIGNED NOT NULL COMMENT "Referencia hacia countries",
    dec_literacy_percent DECIMAL(10,2) NOT NULL COMMENT "Porcentaje de personas alfabetizadas",
    int_school_life_time INT NOT NULL COMMENT "Tiempo en que la persona está en la escuela",
    dec_education_cost_percent_GDP DECIMAL(10,2) NOT NULL COMMENT "Costo en PIB de la educación",
    FOREIGN KEY (id_countries_fk) REFERENCES Countries(id) ON DELETE CASCADE
